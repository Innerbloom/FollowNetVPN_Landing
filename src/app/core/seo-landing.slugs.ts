...
> = {
  ...
  'no-logs-vpn': {
    ...
    ru: 'Приватность VPN',
    de: 'VPN-Datenschutz',
    es: 'Privacidad de la VPN',
    fr: 'Confidentialité du VPN',
    pt: 'Privacidade da VPN',
    uk: 'Приватність VPN',
  },
  'auto-connect-vpn-ios': {
  ...
  'hysteria2-vpn-ios': {
    en: 'Hysteria2 for iOS',
    ru: 'Hysteria2 для iOS',
    de: 'Hysteria2 für iOS',
    es: 'Hysteria2 para iOS',
    fr: 'Hysteria2 pour iOS',
    pt: 'Hysteria2 para iOS',
    uk: 'Hysteria2 для iOS',
  },
  'vpn-chrome-extension': {
    en: 'VPN Chrome extension',
    ru: 'VPN-расширение Chrome',
    de: 'VPN Chrome-Erweiterung',
    es: 'Extensión VPN para Chrome',
    fr: 'Extension VPN Chrome',
    pt: 'Extensão VPN para Chrome',
    uk: 'VPN-розширення Chrome',
  },
  'vpn-widgets-ios': {
    en: 'VPN widgets for iOS',
    ru: 'Виджеты VPN для iOS',
    de: 'VPN-Widgets für iOS',
    es: 'Widgets VPN para iOS',
    fr: 'Widgets VPN pour iOS',
    pt: 'Widgets VPN para iOS',
    uk: 'Віджети VPN для iOS',
  },
  'how-to-setup-vpn-iphone': {
    en: 'How to set up VPN on iPhone',
    ru: 'Как настроить VPN на iPhone',
    de: 'VPN auf dem iPhone einrichten',
    es: 'Cómo configurar VPN en iPhone',
  ...
  'vpn-for-gaming-iphone': {
    ...
    ru: 'VPN для игр на iPhone',
    de: 'VPN für Gaming auf dem iPhone',
    es: 'VPN para juegos en iPhone',
    fr: 'VPN pour le jeu sur iPhone',
    pt: 'VPN para jogos no iPhone',
    uk: 'VPN для ігор на iPhone',
  },
};
