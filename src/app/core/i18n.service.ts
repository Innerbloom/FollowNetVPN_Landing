...
const DICT: Dict = {
  ...
  HERO_LEAD: {
    ...
    pt: 'Free com limites ou Premium completo. Smart Connect, quatro protocolos (incl. AmneziaWG e Hysteria2), perfis DNS, widgets e Speed Test — num app iOS.',
  ...
  APPS_SUB: { ru: 'iOS в App Store. Расширение для Chrome — в Chrome Web Store. macOS — скоро.', en: 'iOS on the App Store. Chrome extension on Chrome Web Store. macOS — soon.', de: 'iOS im App Store. Chrome‑Erweiterung im Chrome Web Store. macOS — bald.', es: 'iOS en App Store. Extensión Chrome en Chrome Web Store. macOS — pronto.', fr: 'iOS sur l’App Store. Extension Chrome sur Chrome Web Store. macOS — bientôt.', pt: 'iOS na App Store. Extensão Chrome na Chrome Web Store. macOS — em breve.', uk: 'iOS у App Store. Розширення Chrome — у Chrome Web Store. macOS — скоро.' },
  ...
  PRICING_TITLE: { ru: 'Premium', en: 'Premium', de: 'Premium', es: 'Premium', fr: 'Premium', pt: 'Premium', uk: 'Premium' },
  PRICING_SUB_1: {
    ru: 'Оплата на сайте картой или в iOS‑приложении через App Store.',
    en: 'Pay on the website by card or subscribe in the iOS app via the App Store.',
    de: 'Zahlung auf der Website per Karte oder im iOS‑App über den App Store.',
    es: 'Pago en la web con tarjeta o en la app iOS con App Store.',
    fr: 'Paiement sur le site par carte ou dans l’app iOS via l’App Store.',
    pt: 'Pague no site com cartão ou no app iOS pela App Store.',
    uk: 'Оплата на сайті карткою або в iOS‑додатку через App Store.',
  },
  PRICING_SUB_2: {
    ru: 'Trial 3 дня — только в приложении.',
    en: '3-day trial is app-only.',
    de: '3 Tage Test nur in der App.',
    es: 'Prueba de 3 días solo en la app.',
    fr: 'Essai 3 jours uniquement dans l’app.',
    pt: 'Teste de 3 dias só no app.',
    uk: 'Trial 3 дні — лише в додатку.',
  },
  ...
  PRICING_NOTE: {
    ru: 'На сайте — оплата картой (WayForPay). Восстановление покупки из App Store — в приложении.',
    en: 'Web checkout uses your card (WayForPay). Restore App Store purchases in the app.',
    de: 'Web‑Zahlung per Karte (WayForPay). App Store‑Käufe in der App wiederherstellen.',
    es: 'Pago web con tarjeta (WayForPay). Restaura compras de App Store en la app.',
    fr: 'Paiement web par carte (WayForPay). Restauration des achats App Store dans l’app.',
    pt: 'Checkout web com cartão (WayForPay). Restaure compras da App Store no app.',
    uk: 'На сайті — оплата карткою (WayForPay). Відновлення покупки з App Store — у додатку.',
  },
  ...
  FAQ_A7: { ru: 'IKEv2, WireGuard, AmneziaWG и Hysteria2 доступны бесплатно (AmneziaWG и Hysteria2 — на серверах, где поддерживаются). Протокол можно выбрать вручную или доверить Smart Connect.', en: 'IKEv2, WireGuard, AmneziaWG, and Hysteria2 are free (AmneziaWG on supported servers). Pick a protocol manually or use Smart Connect.', de: 'IKEv2, WireGuard, AmneziaWG und Hysteria2 sind kostenlos (AmneziaWG auf unterstützten Servern). Manuell wählen oder Smart Connect nutzen.', es: 'IKEv2, WireGuard, AmneziaWG y Hysteria2 son gratis (AmneziaWG en servidores compatibles). Elige manualmente o usa Smart Connect.', fr: 'IKEv2, WireGuard, AmneziaWG et Hysteria2 sont gratuits (AmneziaWG sur serveurs pris en charge). Choix manuel ou Smart Connect.', pt: 'IKEv2, WireGuard, AmneziaWG e Hysteria2 são grátis (AmneziaWG em servidores compatíveis). Escolha manualmente ou use Smart Connect.', uk: 'IKEv2, WireGuard, AmneziaWG та Hysteria2 доступні безкоштовно (AmneziaWG — на серверах, де підтримується). Протокол можна вибрати вручну або довірити Smart Connect.' },
  ...
  FAQ_A9: {
    ...
    en: 'Smart mode in protocol settings lets the app pick the server and protocol (IKEv2, WireGuard, or AmneziaWG, or Hysteria2) for your network—Wi‑Fi or cellular, stability, and common carrier restrictions. You can always choose a protocol manually.',
    de: 'Der Smart‑Modus in den Protokolleinstellungen wählt Server und Protokoll (IKEv2, WireGuard oder AmneziaWG oder Hysteria2) für Ihr Netz—WLAN oder Mobilfunk, Stabilität und übliche Anbieter‑Limits. Manuell wählen geht jederzeit.',
    es: 'El modo inteligente en ajustes de protocolo elige servidor y protocolo (IKEv2, WireGuard o AmneziaWG o Hysteria2) según tu red—Wi‑Fi o datos, estabilidad y restricciones habituales del operador. Siempre puedes elegir manualmente.',
    fr: 'Le mode intelligent dans les réglages protocole choisit serveur et protocole (IKEv2, WireGuard ou AmneziaWG ou Hysteria2) selon votre réseau—Wi‑Fi ou mobile, stabilité et limites courantes de l’opérateur. Choix manuel possible à tout moment.',
    pt: 'O modo inteligente nas configurações de protocolo escolhe servidor e protocolo (IKEv2, WireGuard ou AmneziaWG ou Hysteria2) para sua rede—Wi‑Fi ou celular, estabilidade e restrições comuns da operadora. Você pode escolher manualmente quando quiser.',
    uk: 'Це розумний режим у налаштуваннях протоколу: додаток сам підбирає сервер і протокол (IKEv2, WireGuard або AmneziaWG, або Hysteria2) під вашу мережу — Wi‑Fi чи мобільну, стабільність і типові обмеження оператора. Протокол завжди можна вибрати вручну.',
  },
